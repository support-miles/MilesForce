 <div class="row">
  <div class="col-md-12" id="cpa_can_pro">
     <button href="#" title="Header" data-toggle="popover" data-trigger="hover" data-content="Popover body goes here! Popover body goes here!">Bottom</button>
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                ...
                <tbody>                                             
                    ...
                    <tr class="text-center">
                        ...
                        <td style="vertical-align: middle;"><a href="#" class="primarymobilenum" data-type="primarymobilenum" data-placement="right" data-mobile="987654321" data-pcountrycode="+91" data-title="Enter Mobile">987654321</a>&nbsp;<i class="fa fa-phone-square font-green-jungle onmwbcall" style="font-size:20px;" callcanid="1" mobile="987654321"></i></td>
...
function loadotherdetails(expandcan){ 
       var baseurl = '<?=URL?>';
       $.ajax({
          url : baseurl+'mwb/allcallsotherdetailslist',
          type : 'post',
          data : {
              "canid" : expandcan
          },
...
$(".onmwbcall").click(function(){
     ...
     var mobile = $(this).attr("mobile");
       loadotherdetails(expandcan);
          $.ajax({
             url : 'MilesWorkBook/mwbchatbox.php',
              type : 'post',
             data : {
                  "canid" : expandcan,
                   "mobile" :mobile
